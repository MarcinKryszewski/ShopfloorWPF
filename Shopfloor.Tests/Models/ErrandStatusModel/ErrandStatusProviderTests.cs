...
{
    public class ErrandStatusProviderTests
    {
        private DatabaseConnectionFactory subDatabaseConnectionFactory;

        public ErrandStatusProviderTests()
        {
            this.subDatabaseConnectionFactory = Substitute.For<DatabaseConnectionFactory>();
        }

        private ErrandStatusProvider CreateProvider()
        {
            return new ErrandStatusProvider(
