...
namespace Shopfloor.Models.Activities
{
    ...
    {
        public static async Task ValidateDescription(ActivityCreation item)
        {
        ...
        public static async Task ValidateMachine(ActivityCreation item)
        {
        ...
        public static async Task ValidateOccuranceValue(ActivityCreation item)
        {
        ...
        public static async Task ValidateType(ActivityCreation item)
        {
        ...
        public static async Task ValidateWorkshop(ActivityCreation item)
        {
        ...
        private static Task Description_CheckEmpty(ActivityCreation item, string propertyName, string? value)
        {
        ...
        private static Task Description_CheckLength(ActivityCreation item, string propertyName, string value)
        {
        ...
        private static Task Description_CheckNull(ActivityCreation item, string propertyName, string? value)
        {
        ...
        private static Task Machine_CheckNull(ActivityCreation item, string propertyName, Machine? value)
        {
        ...
        private static Task OccuranceValue_CheckMinimumValue(ActivityCreation item, string propertyName, int value)
        {
        ...
        private static Task Type_CheckNull(ActivityCreation item, string propertyName, ActivityType? value)
        {
        ...
        private static Task Workshop_CheckNull(ActivityCreation item, string propertyName, Workshop? value)
        {
