    ...
    internal class ActionCreateViewModel : ViewModelBase
    {
        ...
        public Line? Line
        {
            ...
            set
            {
                ...
                Application.Current.Dispatcher.Invoke(Machines.Refresh); // TODO: tempory fix
        ...
        public void OnActivitySave(object? sender, Notification? notification)
        {
            if ((notification?.Type ?? null) is NotifierType.Success)
            {
                Activity = new();
                Line = null;
        ...
        private async Task LoadOccurenciesAsync(ActivitiesDataRoot dataRoot)
        {
            ...
            OnPropertyChanged(nameof(Occurencies));
        }
