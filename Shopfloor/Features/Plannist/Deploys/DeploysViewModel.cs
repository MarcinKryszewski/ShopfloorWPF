...
namespace Shopfloor.Features.Plannist
{
    internal sealed class DeploysViewModel : ViewModelBase
    {
        ...
        public DeploysViewModel(SelectedRequestStore selectedRequestStore, ErrandPartStore errandPartStore, ErrandPartCombiner errandPartCombiner)
        {
        ...
        private Task LoadData()
        {
            ...
            _parts = _errandPartStore.Data.Where(part => part.LastStatusText == ErrandPartStatus.Status[6] && part.LastStatus.Confirmed == true).ToList();
